...
const STRINGS: Record<string, Dict> = {
  ...
  "world.close": { ja: "とじる", en: "Close", es: "Cerrar", fr: "Fermer", zh: "关闭", ko: "닫기", ru: "Закрыть" },
  "world.go": { ja: "この町へ行く", en: "Travel here", es: "Viajar aquí", fr: "Voyager ici", zh: "前往此镇", ko: "이 마을로", ru: "Сюда" },
  "world.here": { ja: "たいざい中", en: "You're here", es: "Estás aquí", fr: "Vous êtes ici", zh: "停留中", ko: "체류 중", ru: "Вы здесь" },
  "world.develop": { ja: "町おこし", en: "Develop", es: "Desarrollar", fr: "Développer", zh: "振兴", ko: "마을 살리기", ru: "Развивать" },
  "world.developHint": { ja: "キャラを派遣すると にぎわいが増えて収入アップ！", en: "Dispatch characters to boost income!", es: "¡Envía personajes para más ingresos!", fr: "Envoyez des personnages pour plus de revenus !", zh: "派遣角色提升收入！", ko: "캐릭터를 파견해 수입을 올리자!", ru: "Отправьте героев — доход вырастет!" },
  "world.liveliness": { ja: "にぎわい", en: "Liveliness", es: "Vitalidad", fr: "Animation", zh: "热闹度", ko: "활기", ru: "Оживление" },
  "world.residents": { ja: "住民", en: "Residents", es: "Residentes", fr: "Habitants", zh: "居民", ko: "주민", ru: "Жители" },
  "world.dispatch": { ja: "派遣する", en: "Dispatch", es: "Enviar", fr: "Envoyer", zh: "派遣", ko: "파견", ru: "Отправить" },
  "world.dismiss": { ja: "もどす", en: "Recall", es: "Retirar", fr: "Rappeler", zh: "召回", ko: "되돌리기", ru: "Отозвать" },
  "world.back": { ja: "もどる", en: "Back", es: "Volver", fr: "Retour", zh: "返回", ko: "뒤로", ru: "Назад" },
  "world.none": { ja: "まだ誰もいない", en: "No residents yet", es: "Sin residentes", fr: "Aucun habitant", zh: "还没有居民", ko: "아직 주민 없음", ru: "Пока никого" },
